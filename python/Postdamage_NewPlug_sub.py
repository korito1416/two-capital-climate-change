...
Guess = pickle.load(open(Data_Dir + File_Name2 + "model_tech2_post_damage_gamma_{:.4f}".format(gamma_3_i_sub), "rb"))
...
with open(Data_Dir+ File_Name2 + "model_tech2_post_damage_gamma_{:.4f}".format(gamma_3_i), "wb") as f:
...
# model_tech2_post_damage = pickle.load(open(Data_Dir + File_Name + "model_tech2_post_damage_gamma_{:.4f}".format(gamma_3_i), "rb"))
model_tech2_post_damage = pickle.load(open(Data_Dir + File_Name2 + "model_tech2_post_damage_gamma_{:.4f}".format(gamma_3_i), "rb"))
...
print(Data_Dir + File_Name2 + "model_tech2_post_damage_gamma_{:.4f}".format(gamma_3_i))
...
with open(Data_Dir+ File_Name2 + "model_tech1_post_damage_gamma_{:.4f}".format(gamma_3_i_sub), "rb") as f:
    Guess = pickle.load(f)
...
with open(Data_Dir+ File_Name2  + "model_tech1_post_damage_gamma_{:.4f}".format(gamma_3_i), "wb") as f:
    pickle.dump(res, f)
...
with open(Data_Dir+ File_Name2 + "model_tech1_post_damage_gamma_{:.4f}".format(gamma_3_i), "rb") as f:
    Guess = pickle.load(f)
